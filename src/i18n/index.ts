...
const resources = {
  en: {
    translation: {
      ...
      // Home
      home_tagline: 'Beat the Crowds, Save 50%',
      home_title: "Discover Hong Kong's Best Early Bird Dining Deals",
      home_subtitle: 'Book premium restaurants during beat-the-crowd hours and save 50% on your dining experience.',
      ...
      home_hiw_point1: 'Choose beat-the-crowd hours and enjoy 50% off',
  ...
  'zh-HK': {
    translation: {
      ...
      // Home
      home_tagline: '避開人潮，半價優惠',
      home_title: '發掘香港最佳早鳥餐飲優惠',
      home_subtitle: '在避開人潮時段預訂優質餐廳，享受50%的餐飲體驗折扣。',
      home_featured: '精選餐廳',
      home_browse_all: '瀏覽所有餐廳',
      home_my_bookings: '我的預訂',
      home_how_it_works: '如何運作',
      home_hiw_point1: '選擇避開人潮時段享受 50% 折扣',
